...
### Azure Deployment
- **Production URL**: https://arrow-server-v1.nicerock-8289607a.southeastasia.azurecontainerapps.io/
...
// NetworkModule.kt
class NetworkModule {
    private val baseUrl = "https://arrow-server-v1.nicerock-8289607a.southeastasia.azurecontainerapps.io/api/v1/"
